...
Cal.com's Prisma migration system is mature and battle-tested, with **584+ chronological migrations** in `packages/prisma/migrations/` spanning from `20210605225044_init` to `20260213000000_enable_onboarding_v3_globally`.
