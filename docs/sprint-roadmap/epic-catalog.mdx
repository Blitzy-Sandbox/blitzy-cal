...
`Source: packages/features/availability/lib/date-ranges.ts`
...
| **AV-006** | DST normalization verification for Calendly-equivalent behavior | High | M | AV-001 | `packages/features/availability/lib/date-ranges.ts` |
...
`Source: packages/features/eventtypes/repositories/eventtypes.repository.ts`
...
| Epic ID | Title | Priority | Complexity | Dependencies | Cal.com Package |
|---------|-------|----------|------------|-------------|----------------|
| **CI-001** | Google Calendar sync behavioral parity | Medium | M | AV-001 | `packages/app-store/googlecalendar/` |
| **CI-002** | Outlook/Office 365 sync behavioral parity | Medium | M | AV-001 | `packages/app-store/office365calendar/` |
| **CI-003** | iCloud/Apple Calendar sync parity | Medium | M | AV-001 | `packages/app-store/applecalendar/` |
| **CI-004** | Conflict detection behavior alignment | High | L | CI-001, CI-002, CI-003 | `packages/features/calendars/` |
| **CI-005** | Bi-directional sync verification | High | L | CI-001, CI-002 | `packages/features/calendars/` |
...
| **RF-002** | Conditional routing logic alignment | Medium | L | RF-001 | `packages/features/routing-forms/lib/findMatchingRoute.ts` |
